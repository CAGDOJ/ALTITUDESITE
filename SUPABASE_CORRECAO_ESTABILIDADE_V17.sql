...
-- Verificação final da V17
select
  to_regprocedure('public.gestor_programar_certificado_v15(bigint,text,text)') is not null as funcao_liberacao_ok,
  to_regprocedure('public.processar_certificados_automaticos_v15()') is not null as processamento_automatico_ok,
  to_regprocedure('public.gestor_excluir_solicitacao_certificado(bigint,text)') is not null as exclusao_com_estorno_ok,
  'Correção de estabilidade V17 aplicada com sucesso' as resultado;
